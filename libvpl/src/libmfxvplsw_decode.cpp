...
// stubs
mfxStatus MFXVideoDECODE_Reset(mfxSession session, mfxVideoParam *par) { return MFX_ERR_UNSUPPORTED; }
mfxStatus MFXVideoDECODE_GetDecodeStat(mfxSession session, mfxDecodeStat *stat) { return MFX_ERR_UNSUPPORTED; }
mfxStatus MFXVideoDECODE_SetSkipMode(mfxSession session, mfxSkipMode mode) { return MFX_ERR_UNSUPPORTED; }
mfxStatus MFXVideoDECODE_GetPayload(mfxSession session, mfxU64 *ts, mfxPayload *payload) { return MFX_ERR_UNSUPPORTED; }
