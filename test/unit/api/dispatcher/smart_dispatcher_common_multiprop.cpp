...
static mfxStatus MultiPropInit(mfxImplType implType, mfxLoader *loader, mfxConfig *cfg) {
...
void Dispatcher_MultiProp_MultiConfigMultiPropValid(mfxImplType implType) {
    ...
    mfxStatus sts = MultiPropInit(MFX_IMPL_TYPE_SOFTWARE, &loader, &cfg);
    EXPECT_EQ(sts, MFX_ERR_NONE);
...
void Dispatcher_MultiProp_MultiConfigMultiPropInvalid(mfxImplType implType) {
    ...
    SetConfigFilterProperty<mfxU32>(loader, cfg2, "mfxImplDescription.mfxDecoderDescription.decoder.CodecID", MFX_CODEC_VC1);
...
void Dispatcher_MultiProp_MultiConfigOverwriteInvalid(mfxImplType implType) {
    ...
    SetConfigFilterProperty<mfxU32>(loader, cfg, "mfxImplDescription.mfxDecoderDescription.decoder.CodecID", MFX_CODEC_VC1);
