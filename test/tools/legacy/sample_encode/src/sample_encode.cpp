...
void PrintHelp(msdk_char* strAppName, const msdk_char* strErrorMessage, ...) {
    ...
    msdk_printf(
        MSDK_STRING("   If codecid is jpeg, -q option is mandatory.)\n"));
    ...
    msdk_printf(
        MSDK_STRING("   [-x numRefs]   - number of reference frames\n"));
    msdk_printf(MSDK_STRING(
    ...
    msdk_printf(MSDK_STRING(
        "   [-robust:soft]           - Recovery from GPU hang by inserting an IDR\n"));
    msdk_printf(MSDK_STRING(
...
#if (MFX_VERSION >= 1026)
    msdk_printf(MSDK_STRING(
        "  -TransformSkip:<on,off>- Turn this option ON to enable transformskip\n"));
#endif
    msdk_printf(MSDK_STRING(
    ...
    msdk_printf(MSDK_STRING(
        "   [-trows rows]            - Number of rows for tiled encoding\n"));
    msdk_printf(MSDK_STRING(
        "   [-tcols cols]            - Number of columns for tiled encoding\n"));
    msdk_printf(
        MSDK_STRING("   [-CodecProfile]          - specifies codec profile\n"));
    msdk_printf(
        MSDK_STRING("   [-CodecLevel]            - specifies codec level\n"));
    msdk_printf(MSDK_STRING("   [-GopOptFlag:closed]     - closed gop\n"));
    msdk_printf(MSDK_STRING("   [-GopOptFlag:strict]     - strict gop\n"));
    msdk_printf(MSDK_STRING(
        "   [-AdaptiveI:<on,off>]    - Turn Adaptive I frames on/off\n"));
    msdk_printf(MSDK_STRING(
        "   [-AdaptiveB:<on,off>]    - Turn Adaptive B frames on/off\n"));
    msdk_printf(MSDK_STRING(
    ...
    msdk_printf(
        MSDK_STRING("   [-opencl] - rotation implementation through OPENCL\n"));
    msdk_printf(
        MSDK_STRING(
...
mfxStatus ParseInputString(msdk_char* strInput[],
                           mfxU8 nArgNum,
    ...
    for (mfxU8 i = 1; i < nArgNum; i++) {
        ...
        if (MSDK_CHAR('-') != strInput[i][0]) {
            mfxStatus sts =
                StrFormatToCodecFormatFourCC(strInput[i], pParams->CodecId);
            if (sts != MFX_ERR_NONE) {
        ...
        if (0 == msdk_strcmp(strInput[i], MSDK_STRING("-dstw"))) {
            ...
            if (MFX_ERR_NONE !=
                ...
                PrintHelp(strInput[0],
                          MSDK_STRING("Destination picture Width is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                ...
                PrintHelp(strInput[0],
                          MSDK_STRING("Destination picture Height is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nEncTileRows)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Encoding tile row count is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nEncTileCols)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Encoding tile column count is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nIdrInterval)) {
            ...
            if (MFX_ERR_NONE !=
                ...
                PrintHelp(strInput[0],
                          MSDK_STRING("Rotation Angle is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                ...
                PrintHelp(strInput[0],
                          MSDK_STRING("Look Ahead Depth is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
        ...
        else if (0 == msdk_strcmp(strInput[i],
                                  MSDK_STRING("-single_texture_d3d11"))) {
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->QVBRQuality)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("QVBRQuality param is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nMaxFrameSize)) {
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->CodecLevel)) {
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->CodecProfile)) {
                PrintHelp(strInput[0], MSDK_STRING("CodecProfile is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-GopOptFlag:closed"))) {
            pParams->GopOptFlag = MFX_GOP_CLOSED;
        }
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-GopOptFlag:strict"))) {
            ...
            pParams->AdaptiveB = MFX_CODINGOPTION_OFF;
                 ...
                 msdk_strcmp(strInput[i], MSDK_STRING("-InitialDelayInKB"))) {
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->InitialDelayInKB)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("InitialDelayInKB is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->MaxKbps)) {
            ...
            pParams->LowDelayBRC = MFX_CODINGOPTION_ON;
                 ...
                 msdk_strcmp(strInput[i], MSDK_STRING("-BufferSizeInKB"))) {
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->BufferSizeInKB)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("BufferSizeInKB is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->WinBRCSize)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Sliding window size is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->WinBRCMaxAvgKbps)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Sliding window bitrate is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->TransferMatrix)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Transfer matrix param is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->IntRefType)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Intra refresh type is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->IntRefCycleSize)) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING("IR refresh cycle size param is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->IntRefQPDelta)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("IR QP delta param is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->IntRefCycleDist)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("IR cycle distance param is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->DumpFileName)) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING(
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (msdk_strlen(strInput[i + 1]) >
                MSDK_MAX_USER_DATA_UNREG_SEI_LEN) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING("error: '-usei' arguments is too long\n"));
                return MFX_ERR_UNSUPPORTED;
            }
            if (MFX_ERR_NONE != msdk_opt_read(strInput[++i], pParams->uSEI)) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING("error: option '-usei' expects arguments\n"));
                return MFX_ERR_UNSUPPORTED;
            }
            if (msdk_strlen(pParams->uSEI) < 32) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING(
                        "error: option '-usei' expects at least 32 char uuid\n"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->ICQQuality)) {
            ...
            if (MFX_ERR_NONE != msdk_opt_read(strInput[++i], pParams->nQPI)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Quantizer for I frames is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE != msdk_opt_read(strInput[++i], pParams->nQPP)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Quantizer for P frames is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE != msdk_opt_read(strInput[++i], pParams->nQPB)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Quantizer for B frames is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
#if (MFX_VERSION >= 1027)
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-round_offset_in"))) {
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            ...
            pParams->nGPB = MFX_CODINGOPTION_OFF;
                 ...
                 msdk_strcmp(strInput[i], MSDK_STRING("-TransformSkip:on"))) {
            pParams->nTransformSkip = MFX_CODINGOPTION_ON;
        }
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-TransformSkip:off"))) {
            pParams->nTransformSkip = MFX_CODINGOPTION_OFF;
        }
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-AvcTemporalLayers"))) {
            pParams->nAvcTemp = 1;
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nBaseLayerPID)) {
            ...
            if (MFX_ERR_NONE != msdk_opt_read(strInput[++i], pParams->nPPSId)) {
                ...
                return MFX_ERR_UNSUPPORTED;
                 ...
                 msdk_strcmp(strInput[i], MSDK_STRING("-PicTimingSEI:on"))) {
            pParams->nPicTimingSEI = MFX_CODINGOPTION_ON;
        }
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-PicTimingSEI:off"))) {
            pParams->nPicTimingSEI = MFX_CODINGOPTION_OFF;
        }
        else if (0 == msdk_strcmp(strInput[i],
                                  MSDK_STRING("-NalHrdConformance:on"))) {
            pParams->nNalHrdConformance = MFX_CODINGOPTION_ON;
        }
        else if (0 == msdk_strcmp(strInput[i],
                                  MSDK_STRING("-NalHrdConformance:off"))) {
            pParams->nNalHrdConformance = MFX_CODINGOPTION_OFF;
        }
        else if (0 == msdk_strcmp(strInput[i],
                                  MSDK_STRING("-VuiNalHrdParameters:on"))) {
            pParams->nVuiNalHrdParameters = MFX_CODINGOPTION_ON;
        }
        else if (0 == msdk_strcmp(strInput[i],
                                  MSDK_STRING("-VuiNalHrdParameters:off"))) {
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nNumRefActiveP)) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING(
                        "Number of active reference for P frames is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-num_active_BL0"))) {
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nNumRefActiveBL0)) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING(
                        "Number of active reference for B frames (L0) is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
        else if (0 ==
                 msdk_strcmp(strInput[i], MSDK_STRING("-num_active_BL1"))) {
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nNumRefActiveBL1)) {
                PrintHelp(
                    strInput[0],
                    MSDK_STRING(
                        "Number of active reference for B frames (L1) is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
#if (MFX_VERSION >= 1024)
            ...
            pParams->nExtBRC = EXTBRC_OFF;
                 ...
                 msdk_strcmp(strInput[i], MSDK_STRING("-extbrc:implicit"))) {
            pParams->nExtBRC = EXTBRC_IMPLICIT;
        }
#endif
#if (MFX_VERSION >= 1026)
        else if (0 == msdk_strcmp(strInput[i],
                                  MSDK_STRING("-ExtBrcAdaptiveLTR:on"))) {
            pParams->ExtBrcAdaptiveLTR = MFX_CODINGOPTION_ON;
        }
        else if (0 == msdk_strcmp(strInput[i],
                                  MSDK_STRING("-ExtBrcAdaptiveLTR:off"))) {
            ...
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i],
                              pParams->DeblockingAlphaTcOffset)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Alpha deblocking parameter is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                ...
                PrintHelp(strInput[0],
                          MSDK_STRING("Beta deblocking parameter is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
#endif
            ...
            if (MFX_ERR_NONE != msdk_opt_read(strInput[++i], presetName)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Preset Name is not defined"));
                return MFX_ERR_UNSUPPORTED;
            }
            ...
            if (MFX_ERR_NONE !=
                ...
                PrintHelp(strInput[0],
                          MSDK_STRING("Number of slices is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nNumFrames)) {
                PrintHelp(strInput[0],
                          MSDK_STRING("Number of frames is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            if (MFX_ERR_NONE !=
                ...
                PrintHelp(strInput[0],
                          MSDK_STRING("Height of frames is invalid"));
                return MFX_ERR_UNSUPPORTED;
            }
        }
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nNumRefFrame)) {
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nGopPicSize)) {
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->nGopRefDist)) {
        ...
        MOD_ENC_PARSE_INPUT
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->DeviceName)) {
            ...
            VAL_CHECK(i + 1 >= nArgNum, i, strInput[i]);
            if (MFX_ERR_NONE !=
                msdk_opt_read(strInput[++i], pParams->MipiPort)) {
            ...
            if (!pParams->nTargetUsage) {
                msdk_printf(MSDK_STRING(
                    "error: wrong '-u' parameter. Balanced will be used.\n"));
    ...
    if (MFX_CODEC_JPEG != pParams->CodecId &&
        ...
        PrintHelp(
            strInput[0],
            MSDK_STRING(
                "-yuy2 option is supported only for JPEG or HEVC encoder"));
        return MFX_ERR_UNSUPPORTED;
    }
    ...
    if (MFX_CODEC_HEVC != pParams->CodecId &&
        ...
        PrintHelp(
            strInput[0],
            MSDK_STRING(
                "P010 surfaces are supported only for HEVC and VP9 encoder"));
        return MFX_ERR_UNSUPPORTED;
    }
    ...
    if (pParams->nRotationAngle != 0 && pParams->nRotationAngle != 180) {
        PrintHelp(
            strInput[0],
            MSDK_STRING("Angles other than 180 degrees are not supported."));
        return MFX_ERR_UNSUPPORTED; // other than 180 are not supported
    }

    if (pParams->nQuality && (MFX_CODEC_JPEG != pParams->CodecId)) {
        PrintHelp(strInput[0],
                  MSDK_STRING("-q option is supported only for JPEG encoder"));
        return MFX_ERR_UNSUPPORTED;
    }

    if ((pParams->nTargetUsage || pParams->nBitRate) &&
        (MFX_CODEC_JPEG == pParams->CodecId)) {
        PrintHelp(
            strInput[0],
            MSDK_STRING(
    ...
    if (!pParams->nQuality && (MFX_CODEC_JPEG == pParams->CodecId)) {
        PrintHelp(strInput[0],
                  MSDK_STRING("-q must be specified for JPEG encoder"));
        return MFX_ERR_UNSUPPORTED;
    }
    ...
    if ((nviews <= 1) || (nviews > 2)) {
        if (!(MVC_ENABLED & pParams->MVC_flags)) {
            ...
            PrintHelp(
                strInput[0],
                MSDK_STRING(
                    "Only 2 views are supported right now in this sample."));
            return MFX_ERR_UNSUPPORTED;
        }
    }
    else {
    ...
    if ((pParams->nRateControlMethod == MFX_RATECONTROL_LA) &&
        ...
        PrintHelp(
            strInput[0],
            MSDK_STRING("Look ahead BRC is supported only with -hw option!"));
        return MFX_ERR_UNSUPPORTED;
    }
    ...
    if ((pParams->nMaxSliceSize) && (!pParams->bUseHWLib)) {
        PrintHelp(
            strInput[0],
            MSDK_STRING(
                "MaxSliceSize option is supported only with -hw option!"));
        return MFX_ERR_UNSUPPORTED;
    }
    ...
    if ((pParams->nMaxSliceSize) && (pParams->nNumSlice)) {
        PrintHelp(
            strInput[0],
            MSDK_STRING("-mss and -num_slice options are not compatible!"));
        return MFX_ERR_UNSUPPORTED;
    }
    ...
    if ((pParams->nMaxSliceSize) && (pParams->CodecId != MFX_CODEC_AVC)) {
        PrintHelp(
            strInput[0],
            MSDK_STRING(
                "MaxSliceSize option is supported only with H.264 encoder!"));
        return MFX_ERR_UNSUPPORTED;
    }
    ...
    if (pParams->nLADepth && (pParams->nLADepth < 10)) {
        if ((pParams->nLADepth != 1) || (!pParams->nMaxSliceSize)) {
            PrintHelp(
                strInput[0],
                MSDK_STRING(
                    "Unsupported value of -lad parameter, must be >= 10, or 1 in case of -mss option!"));
            return MFX_ERR_UNSUPPORTED;
        }
    }

    if (pParams->nNumRefActiveP || pParams->nNumRefActiveBL0 ||
        pParams->nNumRefActiveBL1) {
        if (pParams->CodecId != MFX_CODEC_HEVC) {
            PrintHelp(
                strInput[0],
                MSDK_STRING(
                    "NumRefActiveP/BL0/BL1 are supported only with HEVC encoder"));
            return MFX_ERR_UNSUPPORTED;
        }
    }
...
void ModifyParamsUsingPresets(sInputParams& params) {
    ...
    MODIFY_AND_PRINT_PARAM(params.nAsyncDepth,
                           AsyncDepth,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.nBRefType,
                           BRefType,
                           params.shouldPrintPresets);
    //    MODIFY_AND_PRINT_PARAM(params., EnableBPyramid);
    //    MODIFY_AND_PRINT_PARAM(params., EnablePPyramid);
    MODIFY_AND_PRINT_PARAM(params.nGopPicSize,
                           GopPicSize,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.nGopRefDist,
                           GopRefDist,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.IntRefCycleDist,
                           IntRefCycleDist,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.IntRefCycleSize,
                           IntRefCycleSize,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.IntRefQPDelta,
                           IntRefQPDelta,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.IntRefType,
                           IntRefType,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.nLADepth,
                           LookAheadDepth,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.LowDelayBRC,
                           LowDelayBRC,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.nMaxFrameSize,
                           MaxFrameSize,
                           params.shouldPrintPresets);
    ...
    if (params.nRateControlMethod != MFX_RATECONTROL_CQP) {
        MODIFY_AND_PRINT_PARAM(params.nBitRate,
                               TargetKbps,
                               params.shouldPrintPresets);
        MODIFY_AND_PRINT_PARAM(params.MaxKbps,
                               MaxKbps,
                               params.shouldPrintPresets);
        ...
        MODIFY_AND_PRINT_PARAM(params.BufferSizeInKB,
                               BufferSizeInKB,
                               params.shouldPrintPresets);
    }

    MODIFY_AND_PRINT_PARAM(params.nTargetUsage,
                           TargetUsage,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.WeightedBiPred,
                           WeightedBiPred,
                           params.shouldPrintPresets);
    MODIFY_AND_PRINT_PARAM(params.WeightedPred,
                           WeightedPred,
                           params.shouldPrintPresets);
    if (params.shouldPrintPresets) {
        msdk_printf(MSDK_STRING("\n"));
