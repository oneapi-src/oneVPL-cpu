...
FUNCTION(mfxStatus,
         ...
         (mfxSession session, mfxAudioParam *in, mfxAudioParam *out),
         (session, in, out))
FUNCTION(mfxStatus,
...
FUNCTION(mfxStatus,
         MFXAudioENCODE_Init,
         (mfxSession session, mfxAudioParam *par),
         (session, par))
FUNCTION(mfxStatus,
...
FUNCTION(mfxStatus,
         ...
         (mfxSession session,
          ...
          mfxSyncPoint *syncp),
         (session, frame, buffer_out, syncp))
...
FUNCTION(mfxStatus,
         ...
         (mfxSession session,
          mfxBitstream *bs,
          mfxAudioFrame *frame_out,
          mfxSyncPoint *syncp),
         (session, bs, frame_out, syncp))
#endif
